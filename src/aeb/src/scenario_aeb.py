...
class World(object):
    def __init__(self, carla_world, hud):
        ...
        self.npc3 = None
        self.npc4 = None
        self.player_tranform = carla.Transform(carla.Location(x=205, y=9.5, z=1.843102), carla.Rotation(yaw=0.5))
...
def game_loop():
    ...
    try:
        ...
        while True:
            ...
            if player_location.x < 229.2 and yaw <5 :
                world.player.apply_control(world.control2)
                print('acc')
            ...
            #    print('slow straight')
            elif player_location.x > 229.2 and  yaw< 80:
            ...
            #    world.player.apply_control(steer_control)
            #    world.walker2.apply_control(world.walker2_control)
            elif player_location.y < 35.5 and yaw  > 78:
                #print("we in here")
                world.player.apply_control(straight_control)
                print("yaw", yaw)
                #if yaw < 87: 
