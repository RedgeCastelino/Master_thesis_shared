...
class World(object):
    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            spawn_point = carla.Transform(carla.Location(x=119.600000, y=8.330196, z=1.843102),
            ...
            # Spawn the npc cars
            spawn_point = carla.Transform(carla.Location(x=219.600000, y=12.800000, z=1.843102),
                                          carla.Rotation(pitch=0.000000, yaw=0.855823, roll=0.000000))
            ...
            spawn_point = carla.Transform(carla.Location(x=214.123000, y=12.883151, z=1.843102),
                                          carla.Rotation(pitch=0.000000, yaw=0.855823, roll=0.000000))
            ...
            spawn_point = carla.Transform(carla.Location(x=223.013613, y=15.755237, z=2.063102),
...
def Object_List_Talker(world, args):
    ...
    rospy.init_node('camera',
                    anonymous=False)  # Initiate the node camera and anonymous true permitt openinig this node a lot of time including number in the end of the node name
