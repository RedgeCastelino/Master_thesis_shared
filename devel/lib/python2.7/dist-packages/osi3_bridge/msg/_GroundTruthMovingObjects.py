...
"""autogenerated by genpy from osi3_bridge/GroundTruthMovingObjects.msg. Do not edit."""
import codecs
import sys
...
class GroundTruthMovingObjects(genpy.Message):
  _md5sum = "b5c10f964cf85cf58aa709fc3567f543"
  _type = "osi3_bridge/GroundTruthMovingObjects"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GroundTruthMovingObjects, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = osi3_bridge.msg.MovingObject()
        start = end
        end += 8
