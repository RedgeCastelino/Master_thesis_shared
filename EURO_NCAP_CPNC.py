...
class World(object):
    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            self.player.set_velocity(carla.Vector3D(x=0.0001, y=0.000000, z=0.000000))
...
def main():
    ...
    argparser.add_argument(
        ...
        metavar='S',
        default='1',
        help='''Desired AEB Testing Scenario  
        1 - Child Dummie behind parked cars 
        2 - Car stopped in the middle of the Road''')
